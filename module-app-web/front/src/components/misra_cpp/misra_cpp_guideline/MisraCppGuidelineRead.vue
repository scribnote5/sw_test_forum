        ...
        <table class="table mobile-table-read mt-4">
          ...
          <tr class="d-none d-sm-none d-md-none d-lg-table-row">
            ...
            <td>
              ...
              <span v-if="misraCppGuideline.guidelineResult == 'EXCEPTION'">예외 처리(사유서 처리)</span>
              <span v-if="misraCppGuideline.guidelineResult == 'FALSE_ALARM'">도구 오탐(False Alarm)</span>
              <span v-if="misraCppGuideline.guidelineResult == 'FALSE_ALARM_PATCHED'">도구 오탐(False Alarm) 패치 완료</span> <br>
          ...
          <tr class="mobile-only-visible d-md-table-row d-lg-none">
            <td colspan="2">
              ...
              <span v-if="misraCppGuideline.guidelineResult == 'EXCEPTION'">예외 처리(사유서 처리)</span>
              <span v-if="misraCppGuideline.guidelineResult == 'FALSE_ALARM'">도구 오탐(False Alarm)</span>
              <span v-if="misraCppGuideline.guidelineResult == 'FALSE_ALARM_PATCHED'">도구 오탐(False Alarm) 패치 완료,</span> {{ misraCppGuideline.guidelineResultNote }} <br>
