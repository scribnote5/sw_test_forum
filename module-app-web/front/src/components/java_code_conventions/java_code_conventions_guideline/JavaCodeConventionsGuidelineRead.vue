<template>
  <section>
    ...
    <!-- Breadcrumb -->
    <Breadcrumb page="Java Code Conventions 가이드라인" :subPage="javaCodeConventionsRule" :paths="['Java Code Conventions', 'Java Code Conventions 가이드라인 보기']" :title="styleCopGuideline.title"/>
    ...
    <div class="container-fluid">
      ...
      <Comment path="java-code-conventions-guideline-comments" idxName="javaCodeConventionsGuidelineIdx" :idx="styleCopGuideline.idx" :commentList="styleCopGuideline.commentDtoList"></Comment>

      <div class="d-flex justify-content-between flex-column flex-md-row mx-3 my-5">
        <div class="d-flex">
          <router-link :to="this.$route.meta.fromRuleList ? '/java-code-conventions-guideline/list/' + styleCopGuideline.javaCodeConventionsIdx : '/java-code-conventions-guideline/list'" class="me-2">
            <button class="btn btn-main-grey d-flex align-items-center">목록<img :src="require(`@/assets/images/list-white.svg`)" class="ms-2"></button>
          </router-link>
          <router-link :to="'/java-code-conventions/read/' + styleCopGuideline.javaCodeConventionsIdx" class="ms-2">
...
export default {
  ...
  setup() {
    ...
    onBeforeMount(async () => {
      ...
      await axios.get(process.env.VUE_APP_MODULE_APP_API_URL + "/api/java-code-conventions-guidelines/read/" + idx,
          ...
          .then((response) => {
            ...
            styleCopGuideline.value.likeDto.link = "/api/java-code-conventions-guideline-likes/";
      ...
      await axios.get(process.env.VUE_APP_MODULE_APP_API_URL + "/api/java-code-conventions/java-code-conventions-rule/" + styleCopGuideline.value.javaCodeConventionsIdx,
          {},
      )
          .then((response) => {
    ...
    return {
      // variable
      styleCopGuideline, idx, hashTags, compliantExample, nonCompliantExample, badCasePositionList, goodCasePositionList, uploadedAttachedFileList, javaCodeConventionsRule,
