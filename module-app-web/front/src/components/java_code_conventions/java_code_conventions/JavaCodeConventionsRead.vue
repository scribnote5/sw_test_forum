    ...
    <div class="container-fluid">
      <div class="page-content">
        <table class="table mobile-table-read mt-4">
          ...
          <tr>
            <td colspan="2">
              <CodeMirror pageInformation="rule-page-read" :link="'/java-code-conventions-example/list/' + idx" :exampleList="javaCodeConventionsCodeMirror" mode="text/x-csrc"></CodeMirror>
            </td>
          </tr>
          <tr>
            <th colspan="2" class="sub-item-title">Java Code Conventions 가이드라인 사례</th>
          </tr>
          <tr>
            <td colspan="2">
