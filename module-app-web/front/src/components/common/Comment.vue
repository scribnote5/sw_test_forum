...
// utils
import {parseErrorMsg, validateSizeAndIsEmpty} from "@/utils/validation-util";
...
export default {
  ...
  setup(props) {
    ...
    const writeComment = async () => {
      ...
      if (!(validateSizeAndIsEmpty("content", content.value))) {
        return false;
      }
    ...
    const updateComment = async (idx, createdByIdx, activeStatus, index) => {
      ...
      if (!(validateSizeAndIsEmpty("updateCommentContent" + index, updateCommentContent))) {
        return false;
      }
