          ...
          <div class="row justify-content-start">
            ...
            <div class="col-sm-12 col-md-10 card-body">
              ...
              <div class="mb-2 mb-md-3">
                <span data-bs-toggle="modal" data-bs-target="#inquireModal" class="forgot-password-link cursor-pointer">비밀번호 문의</span>
              </div>
              <div class="mb-2 mb-md-3">
                <span class="login-card-register-question-text">회원 가입하지 않았다면?</span> &nbsp;
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="inquireModalLabel">비밀번호 문의</h4>
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <div v-for="(managerUser, i) in managerUserList" :key="i" class="manager-user-list">
                ...
                <a :href="'mailto:' + managerUser.email" class="ms-3">
                  <img :src="require(`@/assets/images/mail.svg`)" class="me-1"/>담당자에게 메일 보내기
                </a>
              </div>
              ...
              <div class="page-content">
                <table class="table mobile-table-read">
                  ...
                  <tr>
                    <th>연락처</th>
                    <td>
                      <input type="text" name="contact" v-model="contact" class="form-control" placeholder="000-0000-0000" @change="validateContact('contact', contact)">
                  ...
                  <tr>
                    <th>이메일</th>
                    <td>
                      <input type="text" name="email" v-model="email" class="form-control" @change="validateEmail('email', email)">
                  ...
                  <tr>
                    <th>개인 이메일</th>
                    <td>
                      <input type="text" name="privateEmail" v-model="privateEmail" class="form-control" @change="validateEmail('privateEmail', privateEmail)">
  ...
  setup() {
    ...
    const writePost = async (vueEditorData) => {
      ...
      if (!(await validateUsername("username", username.value)
          ...
          && validateLengthAndIsEmpty("name", name.value)
          && validateLengthAndIsEmpty("department", department.value)
          && validateLength("position", position.value)
          && validateContact("contact", contact.value)
          && validateEmail("email", email.value)
          && validateEmail("privateEmail", privateEmail.value)
      )) {
        return false;
      }
    ...
    return {
      ...
      // function
      validateEditor, validateUsername, validatePassword, validateEmail, validateContact,
      writePost
    }
  }
}
