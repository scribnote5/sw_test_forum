          ...
          <tr>
            ...
            <td style="overflow: visible">
              <div class="autoComplete_wrapper">
                <input type="text" name="title" id="title" v-model="title" class="form-control" placeholder="[MISRA_C_2012_02_01] 미달성 코드(unreachable code)가 있으면 안된다.">
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      title, priority, frequency, hashTags, category, scope, decidability, activeStatus,
      priorityArray,
