<template>
  <section>
    ...
    <!-- Breadcrumb -->
    <Breadcrumb page="CWE 가이드라인" :subPage="cweRule" :paths="['CWE', 'CWE 가이드라인 수정']" title=""/>
    ...
    <div class="container-fluid">
      <div class="page-content">
        <table class="table mobile-table-read mt-4">
          ...
          <tbody>
          <tr>
            <th colspan="2" class="sub-item-title">CWE 가이드라인 정보</th>
          </tr>
          <tr>
          ...
          <tr>
            <th colspan="2" class="sub-item-title">CWE 가이드라인 부가정보</th>
          </tr>
          <tr>
            <th>작성자</th>
