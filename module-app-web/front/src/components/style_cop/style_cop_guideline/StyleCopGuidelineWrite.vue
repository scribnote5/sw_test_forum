    ...
    <div class="container-fluid">
      <div class="page-content">
        <table class="table mobile-table-read mt-4">
          ...
          <tbody>
          <tr>
            <th colspan="2" class="sub-item-title">C# Coding Convention 가이드라인 정보</th>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="overflow: visible">
              <input type="text" name="projectName" v-model="projectName" class="form-control" placeholder="함정 통합기관제어체계">
