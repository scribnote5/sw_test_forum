        ...
        <table class="table mobile-table-read mt-4">
          ...
          <tr class="mobile-only-visible d-md-table-row d-lg-none">
            <td colspan="2">
              ...
              <span v-if="styleCop.category == 'MAINTAINABILITY_RULES'">Maintainability Rules</span>
              <span v-if="styleCop.category == 'LAYOUT_RULES'">Layout Rules</span>
              <span v-if="styleCop.category == 'DOCUMENTATION_RULES'">Documentation Rules</span><br>
            </td>
          </tr>
          ...
          <tr>
            <th colspan="2" class="sub-item-title">StyleCop 규칙 예제</th>
          </tr>
          <tr>
            <td colspan="2">
              <CodeMirror pageInformation="rule-page-read" :link="'/style-cop-example/list/' + idx" :exampleList="styleCopCodeMirror" mode="text/x-csrc"></CodeMirror>
            </td>
          </tr>
          <tr>
