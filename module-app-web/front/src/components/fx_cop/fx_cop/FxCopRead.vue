        ...
        <table class="table mobile-table-read mt-4">
          ...
          <tr class="d-none d-sm-none d-md-none d-lg-table-row">
            ...
            <td>
              ...
              <span v-if="fxCop.category == 'CRYPTOGRAPHY'">Cryptography</span>
              ...
              <span v-if="fxCop.category == 'SECURITY'">Security</span>
            </td>
          </tr>
          <tr class="d-none d-sm-none d-md-none d-lg-table-row">
          ...
          <tr>
            <th colspan="2" class="sub-item-title">FxCop 규칙 예제</th>
          </tr>
          <tr>
            <td colspan="2">
              <CodeMirror pageInformation="rule-page-read" :link="'/fx-cop-example/list/' + idx" :exampleList="fxCopCodeMirror" mode="text/x-csrc"></CodeMirror>
            </td>
          </tr>
          <tr>
