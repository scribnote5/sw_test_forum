    ...
    <div class="container-fluid">
      <div class="page-content">
        <table class="table mobile-table-read mt-4">
          ...
          <tr>
            <th colspan="2" class="sub-item-title">FxCop 규칙 부가정보</th>
          </tr>
          <tr>
            <th>작성자</th>
...
export default {
  ...
  setup() {
    ...
    // onBeforeMount, init
    onBeforeMount(async () => {
      axios.get(process.env.VUE_APP_MODULE_APP_API_URL + "/api/fx-cop/form/" + idx,
          {},
      )
          .then((response) => {
            ...
            breakingChange.value = response.data.breakingChange;
      ...
      await axios.get(process.env.VUE_APP_MODULE_APP_API_URL + "/api/fx-cop/priority-list-update/" + idx,
          {},
      )
          .then((response) => {
    ...
    const updatePost = async () => {
      ...
      if (!isEmpty(fileUpload.deleteFileArray)) {
        isExit = await axios.delete(process.env.VUE_APP_MODULE_APP_API_URL + "/api/fx-cop/attached-file/", {
      ...
      localStorage.setItem("result", "/fx-cop/update-success");
      router.push("/fx-cop/read/" + idx);
    }
