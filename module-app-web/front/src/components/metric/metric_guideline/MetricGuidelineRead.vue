  ...
  <section>
    ...
    <div class="container-fluid">
      <div class="page-content">
        <table class="table mobile-table-read mt-4">
          ...
          <tr class="d-none d-sm-none d-md-none d-lg-table-row">
            <th>가이드라인 결과</th>
            <td>
              <span v-if="metricGuideline.guidelineResult == 'COMPLETED'">완료</span>
              <span v-if="metricGuideline.guidelineResult == 'EXCLUDE'">사전 제외</span>
              <span v-if="metricGuideline.guidelineResult == 'EXCEPTION'">예외 처리(사유서 처리)</span>
              <span v-if="metricGuideline.guidelineResult == 'FALSE_ALARM'">도구 오탐(False Alarm)</span>
              <span v-if="metricGuideline.guidelineResult == 'FALSE_ALARM_PATCHED'">도구 오탐(False Alarm) 패치 완료</span> <br>
          ...
          <tr class="mobile-only-visible d-md-table-row d-lg-none">
            <td colspan="2">
              ...
              <span v-if="metricGuideline.guidelineResult == 'EXCEPTION'">예외 처리(사유서 처리)</span>
              <span v-if="metricGuideline.guidelineResult == 'FALSE_ALARM'">도구 오탐(False Alarm)</span>
              <span v-if="metricGuideline.guidelineResult == 'FALSE_ALARM_PATCHED'">도구 오탐(False Alarm) 패치 완료, </span> {{ metricGuideline.guidelineResultNote }} <br>
      ...
      <div class="d-flex justify-content-between mx-4 my-5">
        <div class="d-flex">
          <router-link :to="this.$route.meta.fromRuleList ? '/metric-guideline/list/' + metricGuideline.metricIdx : '/metric-guideline/list'">
            <button class="btn btn-main-grey d-flex align-items-center">목록<img :src="require(`@/assets/images/list-white.svg`)" class="ms-2"></button>
          </router-link>
        </div>
        <div class="d-flex" v-if="metricGuideline.access">
