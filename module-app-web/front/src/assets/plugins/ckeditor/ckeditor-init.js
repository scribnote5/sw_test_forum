...
let editorTroubleShootingData =
    ...
    '</p>' +
    '<p>' +
    '    예제) 사업지원팀 ㅇㅇㅇ 과장, <a href="http://support.suresofttech.com/ko/support/tickets/10220">http://support.suresofttech.com/ko/support/tickets/10220</a>' +
    '</p>' +
    '<p>' +
    '    &nbsp;' +
    '</p>' +
...
let editorFinalTestData =
    ...
    '               </p>' +
    '               <p>' +
    '                   예제) 사전 제외) MISRA_C_2012_01_02 - 언어 확장을 사용하면 안된다.' +
    '               </p>' +
    '            </td>' +
    '        </tr>' +
    '        <tr>' +
    ...
    '            <td>' +
    '               <p>' +
    '                   실사 담당관 문의 사항, 실사 담당관 요청 사항, 고객 문의 사항, 고객 요청 사항, 기타 사항) 및 제목을 작성하세요.' +
    '               </p>' +
    '               <p>' +
    '                   예제) 고객 문의 사항) 현재 사용하는 정적시험 도구를 추후 변경하면, 추가로 발생하는 위배에 대한 고객 지원 확인서가 발급되는가?' +
    '               </p>' +
    '            </td>' +
    '        </tr>' +
    '        <tr>' +
    ...
    '               </p>' +
    '               <p>' +
    '                   예제) 고객 요청 사항) 기존 소스 코드에서 변경된 코드에 대해서만 신뢰성시험을 요청.' +
    '               </p>' +
    '            </td>' +
    '        </tr>' +
    '        <tr>' +
...
let editorEducationData =
    ...
    '            <td>' +
    '               <p>' +
    '               고객 문의 사항, 고객 요청 사항) 및 제목을 작성하세요.' +
    '               </p>' +
    '               <p>' +
    '                   예제) 고객 문의 사항) C# 교육 가능 여부' +
    '               </p>' +
    '            </td>' +
    '        </tr>' +
    '        <tr>' +
...
export {
    editor, editorConfig,
    editorGeneralData, editorRuleData, editorExampleData, editorGuidelineData, editorTroubleShootingData, editorFinalTestData, editorEducationData
};