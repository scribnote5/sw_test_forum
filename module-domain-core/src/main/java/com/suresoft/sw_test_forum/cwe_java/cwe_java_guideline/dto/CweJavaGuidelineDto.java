...
@NoArgsConstructor
@ToString
public class CweJavaGuidelineDto extends CommonDto {
    ...
    /* 규칙 정보: number + title */
    private String cweJavaRule;

    /* 첨부 파일 */
    private List<CweJavaGuidelineAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<CweJavaGuidelineCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private CweJavaGuidelineLikeDto likeDto = new CweJavaGuidelineLikeDto();
