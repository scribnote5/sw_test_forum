...
@NoArgsConstructor
@ToString
public class DynamicTestDto extends CommonDto {
    ...
    /* 첨부 파일 */
    private List<DynamicTestAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<DynamicTestCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private DynamicTestLikeDto likeDto = new DynamicTestLikeDto();
