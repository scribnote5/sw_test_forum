...
@NoArgsConstructor
@ToString
public class FxCopGuidelineDto extends CommonDto {
    ...
    /* 첨부 파일 */
    private List<FxCopGuidelineAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<FxCopGuidelineCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private FxCopGuidelineLikeDto likeDto = new FxCopGuidelineLikeDto();
