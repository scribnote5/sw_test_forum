...
@NoArgsConstructor
@ToString
public class JavaCodeConventionsGuidelineDto extends CommonDto {
    ...
    /* 규칙 정보: number + title */
    private String javaCodeConventionsRule;

    /* 첨부 파일 */
    private List<JavaCodeConventionsGuidelineAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<JavaCodeConventionsGuidelineCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private JavaCodeConventionsGuidelineLikeDto likeDto = new JavaCodeConventionsGuidelineLikeDto();
