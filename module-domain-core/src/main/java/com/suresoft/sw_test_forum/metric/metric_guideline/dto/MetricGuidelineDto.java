...
@NoArgsConstructor
@ToString
public class MetricGuidelineDto extends CommonDto {
    /* autoComplete */
    ...
    /* 규칙 정보: number + title */
    private String metricRule;

    /* 첨부 파일 */
    private List<MetricGuidelineAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<MetricGuidelineCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private MetricGuidelineLikeDto likeDto = new MetricGuidelineLikeDto();
