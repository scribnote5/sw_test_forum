package com.suresoft.sw_test_forum.storage.dto;

import com.suresoft.sw_test_forum.storage.domain.StorageAttachedFile;
import com.suresoft.sw_test_forum.storage.domain.enums.Category;
...
@ToString
@NoArgsConstructor
public class StorageDto extends CommonDto {
    ...
    @NotNull(message = "'카테고리'는 NULL이 될 수 없습니다.")
    ...
    /* 첨부 파일 */
    private List<StorageAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<StorageCommentDto> commentDtoList = new ArrayList<>();
}