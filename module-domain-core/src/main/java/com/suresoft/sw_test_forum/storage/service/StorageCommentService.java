...
import com.suresoft.sw_test_forum.storage.dto.mapper.StorageCommentMapper;
import com.suresoft.sw_test_forum.storage.dto.mapper.StorageMapper;
import com.suresoft.sw_test_forum.storage.repository.StorageCommentRepository;
import com.suresoft.sw_test_forum.storage.repository.StorageCommentRepositoryImpl;
...
public class StorageCommentService {
    private final com.suresoft.sw_test_forum.storage.repository.StorageCommentRepository StorageCommentRepository;
    ...
    public long updateStorageComment(long idx, StorageCommentDto StorageCommentDto) {
        StorageComment persistStorageComment = StorageCommentRepository.getById(idx);
