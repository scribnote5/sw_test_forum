...
import com.suresoft.sw_test_forum.storage.dto.StorageSearchDto;
...
import com.suresoft.sw_test_forum.storage.repository.StorageRepository;
import com.suresoft.sw_test_forum.storage.repository.StorageRepositoryImpl;
...
public class StorageService {
    ...
    public long updateStorage(long idx, StorageDto storageDto) {
        Storage persistStorage = storageRepository.getById(idx);
