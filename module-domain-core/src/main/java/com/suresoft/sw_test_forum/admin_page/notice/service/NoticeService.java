...
public class NoticeService {
    ...
    public NoticeDto findNoticeByIdx(long idx) {
        ...
        // 탈퇴 회원은 권한을 general로 설정 후 권한을 검사함
            ...
            noticeDto.setAccess(AuthorityUtil.isAccessInGeneral(createdByUser.getUsername(), createdByUser.getAuthorityType().getAuthorityType()));
            noticeDto.setCreatedByUser(createdByUser);
    ...
    public long updateNotice(long idx, NoticeDto noticeDto) {
        Notice persistNotice = noticeRepository.getById(idx);
