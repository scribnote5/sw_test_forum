...
@NoArgsConstructor
@ToString
public class CweGuidelineDto extends CommonDto {
    private long cweIdx;
    ...
    /* 규칙 정보: number + title */
    private String cweRule;

    /* 첨부 파일 */
    private List<CweGuidelineAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<CweGuidelineCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private CweGuidelineLikeDto likeDto = new CweGuidelineLikeDto();
