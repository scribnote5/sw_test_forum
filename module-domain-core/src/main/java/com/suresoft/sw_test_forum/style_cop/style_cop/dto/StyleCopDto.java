...
@ToString
@NoArgsConstructor
public class StyleCopDto extends CommonDto {
    ...
    /* 예제 */
    private List<StyleCopExampleDto> styleCopExampleDtoList = new ArrayList<>();

    /* 가이드라인 */
    private List<StyleCopGuidelineDto> styleCopGuidelineDtoList = new ArrayList<>();

    /* 첨부 파일 */
    private List<StyleCopAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<StyleCopCommentDto> commentDtoList = new ArrayList<>();
}