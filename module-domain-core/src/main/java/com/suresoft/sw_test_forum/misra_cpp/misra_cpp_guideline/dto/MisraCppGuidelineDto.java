...
@NoArgsConstructor
@ToString
public class MisraCppGuidelineDto extends CommonDto {
    ...
    /* 규칙 정보: number + title */
    private String misraCppRule;

    /* 첨부 파일 */
    private List<MisraCppGuidelineAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<MisraCppGuidelineCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private MisraCppGuidelineLikeDto likeDto = new MisraCppGuidelineLikeDto();
