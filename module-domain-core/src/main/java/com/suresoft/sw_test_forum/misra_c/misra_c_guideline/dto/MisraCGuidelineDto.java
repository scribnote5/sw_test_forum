...
@NoArgsConstructor
@ToString
public class MisraCGuidelineDto extends CommonDto {
    ...
    /* 첨부 파일 */
    private List<MisraCGuidelineAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<MisraCGuidelineCommentDto> commentDtoList = new ArrayList<>();

    /* 좋아요 */
    private MisraCGuidelineLikeDto likeDto = new MisraCGuidelineLikeDto();
