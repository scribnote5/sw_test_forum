...
@ToString
@NoArgsConstructor
public class ToolchainDto extends CommonDto {
    ...
    /* 첨부 파일 */
    private List<ToolchainAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<ToolchainCommentDto> commentDtoList = new ArrayList<>();
}