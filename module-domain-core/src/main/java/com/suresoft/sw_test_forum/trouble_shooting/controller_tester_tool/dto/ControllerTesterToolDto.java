...
@ToString
@NoArgsConstructor
public class ControllerTesterToolDto extends CommonDto {
    ...
    /* 첨부 파일 */
    private List<ControllerTesterToolAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<ControllerTesterToolCommentDto> commentDtoList = new ArrayList<>();
}