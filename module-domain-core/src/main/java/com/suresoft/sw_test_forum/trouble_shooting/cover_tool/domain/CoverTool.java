...
import com.suresoft.sw_test_forum.trouble_shooting.cover_tool.listener.CoverToolListener;
import lombok.*;
...
@NoArgsConstructor
@Entity
@Table(name = "cover_tool")
@EntityListeners(CoverToolListener.class)
public class CoverTool extends CommonAudit {
    ...
    @Builder
    public CoverTool(long idx, LocalDateTime createdDate, LocalDateTime lastModifiedDate, long createdByIdx, long lastModifiedByIdx, ActiveStatus activeStatus,
                     String title,
                     long priority,
                     long hashTagsIdx,
    ...
    public void update(CoverTool staticTool) {
