...
@ToString
@NoArgsConstructor
public class StaticToolDto extends CommonDto {
    ...
    /* 첨부 파일 */
    private List<StaticToolAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<StaticToolCommentDto> commentDtoList = new ArrayList<>();
}