...
@ToString
@NoArgsConstructor
public class CoverToolDto extends CommonDto {
    ...
    /* 첨부 파일 */
    private List<CoverToolAttachedFile> attachedFileList = new ArrayList<>();

    /* 댓글 갯수 */
    private long commentDtoCount;

    /* 댓글 */
    private List<CoverToolCommentDto> commentDtoList = new ArrayList<>();
}