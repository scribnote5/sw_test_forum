...
import com.suresoft.sw_test_forum.trouble_shooting.static_tool.listener.StaticToolListener;
import lombok.*;
...
@EntityListeners(StaticToolListener.class)
public class StaticTool extends CommonAudit {
    ...
    @Builder
    public StaticTool(long idx, LocalDateTime createdDate, LocalDateTime lastModifiedDate, long createdByIdx, long lastModifiedByIdx, ActiveStatus activeStatus,
                      String title,
                      long priority,
                      long hashTagsIdx,
    ...
    public void update(StaticTool staticTool) {
