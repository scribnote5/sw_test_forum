/* java_code_conventions_example table */
DROP TABLE java_code_conventions_example;

CREATE TABLE java_code_conventions_example
(
...
ALTER TABLE java_code_conventions_example
    AUTO_INCREMENT = 1;