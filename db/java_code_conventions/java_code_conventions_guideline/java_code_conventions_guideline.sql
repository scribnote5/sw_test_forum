/* java_code_conventions_guideline table */
DROP TABLE java_code_conventions_guideline;

CREATE TABLE java_code_conventions_guideline
(
    ...
    java_code_conventions_idx bigint default 0,
...
ALTER TABLE java_code_conventions_guideline
    AUTO_INCREMENT = 1;