...
public class TokenProvider implements InitializingBean {
     ...
     * @return
     */
    public String createToken(long userIdx, Authentication authentication) {
        ...
        return Jwts.builder()
                .setSubject(userIdx + "|" + authentication.getName())
                .claim(AUTHORITIES_KEY, authorities)    // JWT payload(JWT의 데이터가 저장되는 공간)
